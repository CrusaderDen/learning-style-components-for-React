...
const cardImg: any = {
    ...
    2: 'https://lh3.googleusercontent.com/proxy/Bi9A0wbKc83Ut2i5DflgaSYLZ4KYFmXjyFlKCnSb2wFg-M4ji6jNnTYxda8_taQwpXlzmd9zjWtEWTDy8nLdsDlLEvQ6t2RjNA',
...
const mainText: any = [
    'Привет', 'sgkdg sopkjgd psjdgpos jdpogjAP', 'tie or ornare in venen.Faucibus. Faucibus. Sit sit sapien sit tempusrisu ut. Sit molestie ornare in venen.Faucibus. Faucibus. Sit sit sapien sit tempusrisu ut. Sit molestie ornare in venen.Faucibus. Faucibus. Sit sit sapien sit tempusrisu ut. Sit molestie ornare in venen.Faucibus. Faucibus. Sit sit sapien sit tempusrisu ut. Sit molestie ornare in venen.Faucibus. Faucibus. Sit sit sapien sit tempusrisu ut. Sit molestie ornare in venen.Faucibus. Faucibus. Sit sit sapien sit tempusrisu ut. Sit molestie ornare in venen.Faucibus. Faucibus. Sit sit sapien sit tempusrisu ut. Sit molestie ornare in venen.Faucibus. Faucibus. Sit sit sapien sit tempusrisu ut. Sit molestie ornare in venen.Faucibus. Faucibus. Sit sit sapien sit tempusrisu ut. Sit molestie ornare in venen.Faucibus. Faucibus. Sit sit sapien sit tempusrisu ut. Sit molestie ornare in venen.',
    `Chrome может предупреждать вас о переходе на сайты с незащищенным подключением, чтобы сделать интернет безопаснее для вас – особенно при использовании общедоступных сетей, например в кофейнях и аэропортах.\n` +
    '\n' +
    'Откройте меню Google Chrome и выберите Настройки.\n' +
    'Нажмите Конфиденциальность и безопасность и выберите Безопасность.\n' +
...
function App() {
    return (
        <CardsBox className="App">
            ...
            <Card
                imgSource={cardImg[1]}
                titleText={'TitleCard1'}
                mainText={mainText[0]}
            />

            <Card
                imgSource={cardImg[4]}
                titleText={'Заголовок новой карточки'}
                mainText={mainText[3]}
            />

            <Card
                imgSource={cardImg[2]}
                titleText={'TitleCard2'}
                mainText={mainText[1]}
            />

            <Card
                imgSource={cardImg[3]}
                titleText={'TitleCard3'}
                mainText={mainText[2]}
            />
